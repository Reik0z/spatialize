...
if __name__ == '__main__':
    ...
    # t1 = time.time()
    # test_esi_idw_anis_2d(loo)
    # print('test_esi_idw_anis_2d: ', time.time()-t1, '[s]')
    
    # t1 = time.time()
    # test_esi_idw_anis_3d(loo)
